...
public class CodeIgniteMITMusic extends AndroidViewComponent {
    ...
    public CodeIgniteMITMusic(ComponentContainer container) {
        ...
        for(String destination:destinations)bottomNav.addView(nav(destination));
    ...
    private LinearLayout controlRow(String[] names){ LinearLayout r=new LinearLayout(container.$context()); r.setGravity(Gravity.CENTER); for(final String n:names){ TextView button=icon(n,new View.OnClickListener(){ public void onClick(View v){ control(n); }}); LinearLayout.LayoutParams lp=new LinearLayout.LayoutParams(dp(44),dp(44)); lp.setMargins(dp(1),0,dp(1),0); r.addView(button,lp); } return r; }
    ...
    private TextView nav(final String t){ TextView v=label(t,14,true); v.setGravity(Gravity.CENTER); v.setPadding(dp(18),0,dp(18),0); v.setMinWidth(dp(104)); v.setOnClickListener(new View.OnClickListener(){ public void onClick(View view){ NavigateTo(t); }}); v.setLayoutParams(new LinearLayout.LayoutParams(-2,-1)); return v; }
